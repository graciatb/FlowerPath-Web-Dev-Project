  ...
  return (
    <div className="flex flex-col h-screen bg-slate-50">
      ...
      <div className="p-7 pl-14 bg-gray-200">
        ...
        <div
          className="pt-7 pl-14 text-2xl text-orange-700 font-bold bg-center"
        >
          {/* Judulnya */}
          <h1>Pengiriman</h1>
        </div>
        ...
        <div className="pl-12 pt-8 px-8 grid grid-cols-2 gap-3">
          ...
          className="flex justify-center w-full py-2 h-10 w-full bg-green-400 bg-opacity-90 rounded-full hover:bg-green-500 text-sm text-green-600 font-semibold hover:text-white ">
            Daftar Pengiriman
          </Link>
        </div>
        ...
        <div className="flex pt-3 pb-2 items-center justify-center md:px-0 w-full">
          ...
          <div className="sm:pt-1 xl:pt-0 sm:pb-2 justify-center xl:pt-4 2xl:px-8 xl:pb-4 w-full flex">
