    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="mt-2 flow-root">
      ...
      <div className="inline-block min-w-full align-middle">
        <div className="rounded-lg bg-gray-100 p-2 md:pt-0">
          ...
          <div className="table-wrp block max-h-30"></div>
              ...
              <tr className="w-full border-b py-3 text-sm last-of-type:border-none [&:first-child>td:first-child]:rounded-tl-lg [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:first-child]:rounded-bl-lg [&:last-child>td:last-child]:rounded-br-lg">
                ...
                <td className="whitespace-nowrap py-3 pl-6 pr-3">
                  <select
                    ...
                    id="status"
                    name="status"
                    className="border border-gray-500 h-7 w-32 py-0 bg-white bg-opacity-90 rounded-full hover:bg-pink-600 text-16 text-pink-600 font-semibold hover:text-white "
                    defaultValue=""
                  >
                    <option value=" " disabled>
                      {detail.statuspengiriman}
      ...
      <div className="flex items-center pt-3 px-8 pb-0">
              ...
              <div className="text-black font-medium text-sm">
                ...
                >
                  <textarea
                    ...
                    className="peer block xl:h-28 md:h-20 sm:h-20 w-full rounded border-1 border-gray-500 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:peer-focus:text-primary [&:not([data-te-input-placeholder-active])]:placeholder:opacity-100"
                    rows={4}
      ...
      <div className="justify-center sm:pt-1 xl:pt-0 2xl:px-8 xl:pb-4 w-full flex">
        <button
          type="submit"
          className="h-8 w-48 bg-pink-600 bg-opacity-90 rounded-full hover:bg-pink-400 xl:text-sm text-white font-semibold hover:text-pink-600 peer-disabled:text-transparent peer-placeholder-shown:text-transparent after:text-transparent"
        >
          Selesai
